...
;;; Time-stamp: <2007-09-23 23:03:44 jcgs>
...
(defun csv-vocab-column ()
  "Return the current CSV column number."
...
(defun csv-vocab-mode-after-motion-check ()
  "See whether we are now in a different csv-column, requiring a different input mode."
  (condition-case evar
